...
<div class='row'>
 ...
 <div class='row'>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <input type="text" class="form-control"   id="customername" name="customername" required='required' placeholder="Firstname MI Lastname" disabled autocomplete="off">
            </div>
          </div>
          <div class="col-md-2">
             <div class="form-group">
  ...
  <?php
      ...
      echo "<div class='row'>
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <input type='text' class='form-control'   id='cust_id_off' name='cust_id_off' placeholder='Offline Customer ID' disabled autocomplete='off'>
                        </div>
                    </div>
            </div>";
...
<script>
		...
		$("#btnCustomerFind").click(function()
    {
			...
			$.post('jsquery/customerDetails.php',{query:query},function(data){
