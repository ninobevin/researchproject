...
<form action="" method="POST" class="form-inline" role="form">
	...
	<div class='row'>
		<div class="form-group">
			 <a href="pdfPrintChrono.php?account_no=<?php echo @$_REQUEST['account_no'].'&dateFormValue='.$date.'&dateTo='.$dateTo;?>">Print this document? Click here</a>
		</div>
	</div>	
	<hr>
	...
	<?php
	    ...
	    $queryStr = "select a.balance,c.name as status,a.status as statusNum,b.name as accountname,a.date as date,a.date_claimed as date_claimed,a.ref_no as ref_no,a.amount as amount
	  			   from transaction_sm a join account_sm b on a.account=b.account_no
	  			    join status_sm c on a.status=c.sm_status_no where a.account=$account_no and date_format(a.date,'%Y-%m-%d') between '$date' and '$dateTo' 
	  			    order by a.date;";
