	...
	<div class='container' >
		...
		<?php
			...
			if(isset($_REQUEST['updatAccount']))
            {
            	...
            	//echo "$isMatch || $isValid";

			      if($isMatch || $isValid)
			      {

			      		//echo "Update users set username='$username',password='$newPassword' where user_id=".$_SESSION['userz']['user_id']."";
		...
		?>
			...
			<form method="POST" action='' id='selfForm' role="form" name="updateACC">
				...
				<div class="row">
					...
					<div class="col-md-4">
			              <div class="form-group">
			                <input type="text" placeholder="New Username here..." autocomplete="off" class="form-control"  style='width:100%;'   id="username" name="username" required='required'>
			              </div>
			              <div class="form-group" style='text-align:center;'>
				...
				<div class="row">
					...
					<div class="col-md-4">
			              <div class="form-group">
			                <input type="text" placeholder="New password here..." autocomplete="off" class="form-control"  style='width:100%;'   id="newPassword" name="newPassword" required='required'>
			              </div>
			              <div class="form-group" style='text-align:center;'>
				...
				<div class="row">
					...
					<div class="col-md-4">
			              <div class="form-group">
			                <input type="text" class="form-control" autocomplete="off" placeholder="Input again..." style='width:100%;'   id="verifyPassword" name="verifyPassword" required='required'>
			              </div>
			              <div class="form-group" style='text-align:center;'>
				...
				<div class="row">
					...
					<div class="col-md-4">
			              <div class="form-group">
			                <input type="text" class="form-control" autocomplete="off" placeholder="Input old Password" style='width:100%;'   id="olpPassword" name="olpPassword" required='required'>
			              </div>
			              <div class="form-group" style='text-align:center;'>
