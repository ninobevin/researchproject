    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Select Case ButtonState
            Case ButtonHover.Minimize
                G.DrawString("0", ButtonFont, New SolidBrush(Color.Black), New Point(20, 7), New StringFormat With {.Alignment = StringAlignment.Center})
            Case ButtonHover.Close
                G.DrawString("r", ButtonFont, New SolidBrush(Color.Black), New Point(Width - 16, 7), New StringFormat With {.Alignment = StringAlignment.Center})
        End Select
...
Class TwitchGroupBox
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.FillRectangle(New SolidBrush(Color.LightGray), New Rectangle(0, 0, Width, 26))
