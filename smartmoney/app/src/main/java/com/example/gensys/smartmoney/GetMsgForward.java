...
public class GetMsgForward extends AsyncTask {
    ...
    protected Object doInBackground(Object[] params) {
        ...
        while(true){
            String result = ruc.getData("http://"+GO.getIp()+"/"+ GO.getPath() +"/getmsgs.php");
            ...
            try {
              ...
              //  JSONArray Jrr = JO.getJSONArray(0);
                ...
                for(int i =0;i < jObj.length();i++) {
                    ...
                    String longMessage = jobj2.get("sms_body").toString();
                    String contact = jobj2.get("mobile_no").toString();
                    ...
                    Log.i("SENT",jobj2.get("sms_body").toString());
