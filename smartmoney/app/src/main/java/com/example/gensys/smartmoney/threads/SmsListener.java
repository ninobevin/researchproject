            ...
            if (bundle != null){
                ...
                try{
                    ...
                    for(int i=0; i<msgs.length; i++){
                        ...
                        if(msgs[i].getOriginatingAddress().toString().equals("SmartPadala") ||
                                msgs[i].getOriginatingAddress().toString().equals("SMARTMoney")    ) {

                            Log.i("testing >>", msgs[i].getOriginatingAddress().toString());
